...
void Vtop::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+332,"resetn", false,-1);
        tracep->declBit(c+333,"trap", false,-1);
        tracep->declBus(c+334,"out_data", false,-1, 31,0);
        tracep->declBit(c+335,"out_valid", false,-1);
        tracep->declBit(c+331,"top clk", false,-1);
        tracep->declBit(c+332,"top resetn", false,-1);
        tracep->declBit(c+333,"top trap", false,-1);
        tracep->declBus(c+334,"top out_data", false,-1, 31,0);
        tracep->declBit(c+335,"top out_valid", false,-1);
        tracep->declBus(c+336,"top MEM_SIZE", false,-1, 31,0);
        tracep->declBit(c+1,"top mem_valid", false,-1);
        tracep->declBit(c+2,"top mem_instr", false,-1);
        tracep->declBit(c+337,"top mem_ready", false,-1);
        tracep->declBus(c+3,"top mem_addr", false,-1, 31,0);
        tracep->declBus(c+4,"top mem_wdata", false,-1, 31,0);
        tracep->declBus(c+5,"top mem_wstrb", false,-1, 3,0);
        tracep->declBus(c+6,"top mem_rdata", false,-1, 31,0);
        tracep->declBit(c+7,"top pcpi_valid", false,-1);
        tracep->declBus(c+8,"top pcpi_insn", false,-1, 31,0);
        tracep->declBus(c+9,"top pcpi_rs1", false,-1, 31,0);
        tracep->declBus(c+10,"top pcpi_rs2", false,-1, 31,0);
        tracep->declBit(c+337,"top pcpi_wr", false,-1);
        tracep->declBus(c+11,"top pcpi_rd", false,-1, 31,0);
        tracep->declBit(c+338,"top pcpi_wait", false,-1);
        tracep->declBit(c+12,"top pcpi_ready", false,-1);
        tracep->declBus(c+339,"top cpu ENABLE_COUNTERS", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu ENABLE_COUNTERS64", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu ENABLE_REGS_16_31", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu ENABLE_REGS_DUALPORT", false,-1, 0,0);
        tracep->declBus(c+340,"top cpu LATCHED_MEM_RDATA", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu TWO_STAGE_SHIFT", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu BARREL_SHIFTER", false,-1, 0,0);
        tracep->declBus(c+340,"top cpu TWO_CYCLE_COMPARE", false,-1, 0,0);
        tracep->declBus(c+340,"top cpu TWO_CYCLE_ALU", false,-1, 0,0);
        tracep->declBus(c+340,"top cpu COMPRESSED_ISA", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu CATCH_MISALIGN", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu CATCH_ILLINSN", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu ENABLE_PCPI", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu ENABLE_MUL", false,-1, 0,0);
        tracep->declBus(c+340,"top cpu ENABLE_FAST_MUL", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu ENABLE_DIV", false,-1, 0,0);
        tracep->declBus(c+340,"top cpu ENABLE_IRQ", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu ENABLE_IRQ_QREGS", false,-1, 0,0);
        tracep->declBus(c+339,"top cpu ENABLE_IRQ_TIMER", false,-1, 0,0);
        tracep->declBus(c+340,"top cpu ENABLE_TRACE", false,-1, 0,0);
        tracep->declBus(c+340,"top cpu REGS_INIT_ZERO", false,-1, 0,0);
        tracep->declBus(c+341,"top cpu MASKED_IRQ", false,-1, 31,0);
        tracep->declBus(c+342,"top cpu LATCHED_IRQ", false,-1, 31,0);
        tracep->declBus(c+341,"top cpu PROGADDR_RESET", false,-1, 31,0);
        tracep->declBus(c+343,"top cpu PROGADDR_IRQ", false,-1, 31,0);
        tracep->declBus(c+344,"top cpu STACKADDR", false,-1, 31,0);
        tracep->declBit(c+331,"top cpu clk", false,-1);
        tracep->declBit(c+332,"top cpu resetn", false,-1);
        tracep->declBit(c+333,"top cpu trap", false,-1);
        tracep->declBit(c+1,"top cpu mem_valid", false,-1);
        tracep->declBit(c+2,"top cpu mem_instr", false,-1);
        tracep->declBit(c+337,"top cpu mem_ready", false,-1);
        tracep->declBus(c+3,"top cpu mem_addr", false,-1, 31,0);
        tracep->declBus(c+4,"top cpu mem_wdata", false,-1, 31,0);
        tracep->declBus(c+5,"top cpu mem_wstrb", false,-1, 3,0);
        tracep->declBus(c+6,"top cpu mem_rdata", false,-1, 31,0);
        tracep->declBit(c+327,"top cpu mem_la_read", false,-1);
        tracep->declBit(c+328,"top cpu mem_la_write", false,-1);
        tracep->declBus(c+13,"top cpu mem_la_addr", false,-1, 31,0);
        tracep->declBus(c+14,"top cpu mem_la_wdata", false,-1, 31,0);
        tracep->declBus(c+15,"top cpu mem_la_wstrb", false,-1, 3,0);
        tracep->declBit(c+7,"top cpu pcpi_valid", false,-1);
        tracep->declBus(c+8,"top cpu pcpi_insn", false,-1, 31,0);
        tracep->declBus(c+9,"top cpu pcpi_rs1", false,-1, 31,0);
        tracep->declBus(c+10,"top cpu pcpi_rs2", false,-1, 31,0);
        tracep->declBit(c+337,"top cpu pcpi_wr", false,-1);
        tracep->declBus(c+11,"top cpu pcpi_rd", false,-1, 31,0);
        tracep->declBit(c+338,"top cpu pcpi_wait", false,-1);
        tracep->declBit(c+12,"top cpu pcpi_ready", false,-1);
        tracep->declBus(c+345,"top cpu irq", false,-1, 31,0);
        tracep->declBus(c+16,"top cpu eoi", false,-1, 31,0);
        tracep->declBit(c+17,"top cpu trace_valid", false,-1);
        tracep->declQuad(c+18,"top cpu trace_data", false,-1, 35,0);
        tracep->declBus(c+346,"top cpu irq_timer", false,-1, 31,0);
        tracep->declBus(c+347,"top cpu irq_ebreak", false,-1, 31,0);
        tracep->declBus(c+348,"top cpu irq_buserror", false,-1, 31,0);
        tracep->declBus(c+349,"top cpu irqregs_offset", false,-1, 31,0);
        tracep->declBus(c+349,"top cpu regfile_size", false,-1, 31,0);
        tracep->declBus(c+350,"top cpu regindex_bits", false,-1, 31,0);
        tracep->declBus(c+339,"top cpu WITH_PCPI", false,-1, 0,0);
        tracep->declQuad(c+351,"top cpu TRACE_BRANCH", false,-1, 35,0);
        tracep->declQuad(c+353,"top cpu TRACE_ADDR", false,-1, 35,0);
        tracep->declQuad(c+355,"top cpu TRACE_IRQ", false,-1, 35,0);
        tracep->declQuad(c+20,"top cpu count_cycle", false,-1, 63,0);
        tracep->declQuad(c+22,"top cpu count_instr", false,-1, 63,0);
        tracep->declBus(c+24,"top cpu reg_pc", false,-1, 31,0);
        tracep->declBus(c+25,"top cpu reg_next_pc", false,-1, 31,0);
        tracep->declBus(c+9,"top cpu reg_op1", false,-1, 31,0);
        tracep->declBus(c+10,"top cpu reg_op2", false,-1, 31,0);
        tracep->declBus(c+26,"top cpu reg_out", false,-1, 31,0);
        tracep->declBus(c+27,"top cpu reg_sh", false,-1, 4,0);
        tracep->declBus(c+28,"top cpu next_insn_opcode", false,-1, 31,0);
        tracep->declBus(c+29,"top cpu dbg_insn_opcode", false,-1, 31,0);
        tracep->declBus(c+30,"top cpu dbg_insn_addr", false,-1, 31,0);
        tracep->declBit(c+1,"top cpu dbg_mem_valid", false,-1);
        tracep->declBit(c+2,"top cpu dbg_mem_instr", false,-1);
        tracep->declBit(c+337,"top cpu dbg_mem_ready", false,-1);
        tracep->declBus(c+3,"top cpu dbg_mem_addr", false,-1, 31,0);
        tracep->declBus(c+4,"top cpu dbg_mem_wdata", false,-1, 31,0);
        tracep->declBus(c+5,"top cpu dbg_mem_wstrb", false,-1, 3,0);
        tracep->declBus(c+6,"top cpu dbg_mem_rdata", false,-1, 31,0);
        tracep->declBus(c+31,"top cpu next_pc", false,-1, 31,0);
        tracep->declBit(c+32,"top cpu irq_delay", false,-1);
        tracep->declBit(c+33,"top cpu irq_active", false,-1);
        tracep->declBus(c+34,"top cpu irq_mask", false,-1, 31,0);
        tracep->declBus(c+35,"top cpu irq_pending", false,-1, 31,0);
        tracep->declBus(c+36,"top cpu timer", false,-1, 31,0);
        {int i; for (i=0; i<32; i++) {
                tracep->declBus(c+37+i*1,"top cpu cpuregs", true,(i+0), 31,0);}}
        tracep->declBus(c+357,"top cpu i", false,-1, 31,0);
        tracep->declBit(c+69,"top cpu pcpi_mul_wr", false,-1);
        tracep->declBus(c+70,"top cpu pcpi_mul_rd", false,-1, 31,0);
        tracep->declBit(c+71,"top cpu pcpi_mul_wait", false,-1);
        tracep->declBit(c+72,"top cpu pcpi_mul_ready", false,-1);
        tracep->declBit(c+73,"top cpu pcpi_div_wr", false,-1);
        tracep->declBus(c+74,"top cpu pcpi_div_rd", false,-1, 31,0);
        tracep->declBit(c+75,"top cpu pcpi_div_wait", false,-1);
        tracep->declBit(c+76,"top cpu pcpi_div_ready", false,-1);
        tracep->declBit(c+77,"top cpu pcpi_int_wr", false,-1);
        tracep->declBus(c+78,"top cpu pcpi_int_rd", false,-1, 31,0);
        tracep->declBit(c+79,"top cpu pcpi_int_wait", false,-1);
        tracep->declBit(c+80,"top cpu pcpi_int_ready", false,-1);
        tracep->declBus(c+81,"top cpu mem_state", false,-1, 1,0);
        tracep->declBus(c+82,"top cpu mem_wordsize", false,-1, 1,0);
        tracep->declBus(c+83,"top cpu mem_rdata_word", false,-1, 31,0);
        tracep->declBus(c+84,"top cpu mem_rdata_q", false,-1, 31,0);
        tracep->declBit(c+85,"top cpu mem_do_prefetch", false,-1);
        tracep->declBit(c+86,"top cpu mem_do_rinst", false,-1);
        tracep->declBit(c+87,"top cpu mem_do_rdata", false,-1);
        tracep->declBit(c+88,"top cpu mem_do_wdata", false,-1);
        tracep->declBit(c+1,"top cpu mem_xfer", false,-1);
        ...
        tracep->declBit(c+338,"top cpu mem_la_firstword", false,-1);
        tracep->declBit(c+338,"top cpu mem_la_firstword_xfer", false,-1);
        tracep->declBit(c+92,"top cpu prefetched_high_word", false,-1);
        tracep->declBit(c+329,"top cpu clear_prefetched_high_word", false,-1);
        tracep->declBus(c+358,"top cpu mem_16bit_buffer", false,-1, 15,0);
        ...
        tracep->declBit(c+338,"top cpu mem_la_use_prefetched_high_word", false,-1);
        tracep->declBit(c+94,"top cpu mem_busy", false,-1);
        tracep->declBit(c+330,"top cpu mem_done", false,-1);
        ...
        tracep->declBus(c+359,"top cpu cpu_state_trap", false,-1, 7,0);
        tracep->declBus(c+360,"top cpu cpu_state_fetch", false,-1, 7,0);
        tracep->declBus(c+361,"top cpu cpu_state_ld_rs1", false,-1, 7,0);
        tracep->declBus(c+362,"top cpu cpu_state_ld_rs2", false,-1, 7,0);
        tracep->declBus(c+363,"top cpu cpu_state_exec", false,-1, 7,0);
        tracep->declBus(c+364,"top cpu cpu_state_shift", false,-1, 7,0);
        tracep->declBus(c+365,"top cpu cpu_state_stmem", false,-1, 7,0);
        tracep->declBus(c+366,"top cpu cpu_state_ldmem", false,-1, 7,0);
        ...
        tracep->declBus(c+367,"top cpu decoded_rs", false,-1, 4,0);
        tracep->declBus(c+368,"top cpu genblk2 pcpi_mul STEPS_AT_ONCE", false,-1, 31,0);
        tracep->declBus(c+369,"top cpu genblk2 pcpi_mul CARRY_CHAIN", false,-1, 31,0);
        tracep->declBit(c+331,"top cpu genblk2 pcpi_mul clk", false,-1);
        tracep->declBit(c+332,"top cpu genblk2 pcpi_mul resetn", false,-1);
        tracep->declBit(c+7,"top cpu genblk2 pcpi_mul pcpi_valid", false,-1);
        tracep->declBus(c+8,"top cpu genblk2 pcpi_mul pcpi_insn", false,-1, 31,0);
        tracep->declBus(c+9,"top cpu genblk2 pcpi_mul pcpi_rs1", false,-1, 31,0);
        tracep->declBus(c+10,"top cpu genblk2 pcpi_mul pcpi_rs2", false,-1, 31,0);
        tracep->declBit(c+69,"top cpu genblk2 pcpi_mul pcpi_wr", false,-1);
        tracep->declBus(c+70,"top cpu genblk2 pcpi_mul pcpi_rd", false,-1, 31,0);
        tracep->declBit(c+71,"top cpu genblk2 pcpi_mul pcpi_wait", false,-1);
        tracep->declBit(c+72,"top cpu genblk2 pcpi_mul pcpi_ready", false,-1);
        ...
        tracep->declBus(c+347,"top cpu genblk2 pcpi_mul i", false,-1, 31,0);
        tracep->declBus(c+370,"top cpu genblk2 pcpi_mul j", false,-1, 31,0);
        tracep->declBit(c+331,"top cpu genblk4 pcpi_div clk", false,-1);
        tracep->declBit(c+332,"top cpu genblk4 pcpi_div resetn", false,-1);
        tracep->declBit(c+7,"top cpu genblk4 pcpi_div pcpi_valid", false,-1);
        tracep->declBus(c+8,"top cpu genblk4 pcpi_div pcpi_insn", false,-1, 31,0);
        tracep->declBus(c+9,"top cpu genblk4 pcpi_div pcpi_rs1", false,-1, 31,0);
        tracep->declBus(c+10,"top cpu genblk4 pcpi_div pcpi_rs2", false,-1, 31,0);
        tracep->declBit(c+73,"top cpu genblk4 pcpi_div pcpi_wr", false,-1);
        tracep->declBus(c+74,"top cpu genblk4 pcpi_div pcpi_rd", false,-1, 31,0);
        tracep->declBit(c+75,"top cpu genblk4 pcpi_div pcpi_wait", false,-1);
        tracep->declBit(c+76,"top cpu genblk4 pcpi_div pcpi_ready", false,-1);
        tracep->declBit(c+270,"top cpu genblk4 pcpi_div instr_div", false,-1);
        tracep->declBit(c+271,"top cpu genblk4 pcpi_div instr_divu", false,-1);
        tracep->declBit(c+272,"top cpu genblk4 pcpi_div instr_rem", false,-1);
        tracep->declBit(c+273,"top cpu genblk4 pcpi_div instr_remu", false,-1);
        tracep->declBit(c+274,"top cpu genblk4 pcpi_div instr_any_div_rem", false,-1);
        tracep->declBit(c+275,"top cpu genblk4 pcpi_div pcpi_wait_q", false,-1);
        tracep->declBit(c+276,"top cpu genblk4 pcpi_div start", false,-1);
        tracep->declBus(c+277,"top cpu genblk4 pcpi_div dividend", false,-1, 31,0);
        tracep->declQuad(c+278,"top cpu genblk4 pcpi_div divisor", false,-1, 62,0);
        tracep->declBus(c+280,"top cpu genblk4 pcpi_div quotient", false,-1, 31,0);
        tracep->declBus(c+281,"top cpu genblk4 pcpi_div quotient_msk", false,-1, 31,0);
        tracep->declBit(c+282,"top cpu genblk4 pcpi_div running", false,-1);
        tracep->declBit(c+283,"top cpu genblk4 pcpi_div outsign", false,-1);
        tracep->declBit(c+331,"top my_accel clk", false,-1);
        tracep->declBit(c+332,"top my_accel resetn", false,-1);
        tracep->declBit(c+7,"top my_accel pcpi_valid", false,-1);
        tracep->declBus(c+8,"top my_accel pcpi_insn", false,-1, 31,0);
        tracep->declBus(c+9,"top my_accel pcpi_rs1", false,-1, 31,0);
        tracep->declBus(c+10,"top my_accel pcpi_rs2", false,-1, 31,0);
        tracep->declBit(c+284,"top my_accel pcpi_wr", false,-1);
        tracep->declBus(c+11,"top my_accel pcpi_rd", false,-1, 31,0);
        tracep->declBit(c+12,"top my_accel pcpi_ready", false,-1);
        tracep->declBit(c+338,"top my_accel pcpi_wait", false,-1);
        tracep->declBit(c+285,"top my_accel is_my_instruction", false,-1);
        {int i; for (i=0; i<8; i++) {
                tracep->declBus(c+286+i*1,"top my_accel a_raw", true,(i+0), 3,0);}}
        {int i; for (i=0; i<8; i++) {
                tracep->declBus(c+294+i*1,"top my_accel b_raw", true,(i+0), 3,0);}}
        {int i; for (i=0; i<8; i++) {
                tracep->declBus(c+302+i*1,"top my_accel a_val", true,(i+0), 11,0);}}
        {int i; for (i=0; i<8; i++) {
                tracep->declBus(c+310+i*1,"top my_accel b_val", true,(i+0), 11,0);}}
        {int i; for (i=0; i<8; i++) {
                tracep->declBus(c+318+i*1,"top my_accel prod", true,(i+0), 23,0);}}
        tracep->declBus(c+326,"top my_accel dot_product", false,-1, 31,0);
    }
}
...
void Vtop::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullIData(oldp+3,(vlTOPp->top__DOT__mem_addr),32);
        tracep->fullIData(oldp+4,(vlTOPp->top__DOT__mem_wdata),32);
        tracep->fullCData(oldp+5,(vlTOPp->top__DOT__mem_wstrb),4);
        tracep->fullIData(oldp+6,(vlTOPp->top__DOT__mem_rdata),32);
        tracep->fullBit(oldp+7,(vlTOPp->top__DOT__pcpi_valid));
        tracep->fullIData(oldp+8,(vlTOPp->top__DOT__pcpi_insn),32);
        tracep->fullIData(oldp+9,(vlTOPp->top__DOT__cpu__DOT__reg_op1),32);
        tracep->fullIData(oldp+10,(vlTOPp->top__DOT__cpu__DOT__reg_op2),32);
        tracep->fullIData(oldp+11,(vlTOPp->top__DOT__pcpi_rd),32);
        tracep->fullBit(oldp+12,(vlTOPp->top__DOT__pcpi_ready));
        tracep->fullIData(oldp+13,((((IData)(vlTOPp->top__DOT__cpu__DOT__mem_do_prefetch) 
                                     | (IData)(vlTOPp->top__DOT__cpu__DOT__mem_do_rinst))
                                     ? (0xfffffffcU 
                                        & vlTOPp->top__DOT__cpu__DOT__next_pc)
                                     : (0xfffffffcU 
                                        & vlTOPp->top__DOT__cpu__DOT__reg_op1))),32);
        tracep->fullIData(oldp+14,(vlTOPp->top__DOT__cpu__DOT__mem_la_wdata),32);
        tracep->fullCData(oldp+15,(vlTOPp->top__DOT__cpu__DOT__mem_la_wstrb),4);
        tracep->fullIData(oldp+16,(vlTOPp->top__DOT__cpu__DOT__eoi),32);
        tracep->fullBit(oldp+17,(vlTOPp->top__DOT__cpu__DOT__trace_valid));
        tracep->fullQData(oldp+18,(vlTOPp->top__DOT__cpu__DOT__trace_data),36);
        tracep->fullQData(oldp+20,(vlTOPp->top__DOT__cpu__DOT__count_cycle),64);
        tracep->fullQData(oldp+22,(vlTOPp->top__DOT__cpu__DOT__count_instr),64);
        tracep->fullIData(oldp+24,(vlTOPp->top__DOT__cpu__DOT__reg_pc),32);
        tracep->fullIData(oldp+25,(vlTOPp->top__DOT__cpu__DOT__reg_next_pc),32);
        tracep->fullIData(oldp+26,(vlTOPp->top__DOT__cpu__DOT__reg_out),32);
        tracep->fullCData(oldp+27,(vlTOPp->top__DOT__cpu__DOT__reg_sh),5);
        tracep->fullIData(oldp+28,(vlTOPp->top__DOT__cpu__DOT__next_insn_opcode),32);
        tracep->fullIData(oldp+29,(vlTOPp->top__DOT__cpu__DOT__dbg_insn_opcode),32);
        tracep->fullIData(oldp+30,(vlTOPp->top__DOT__cpu__DOT__dbg_insn_addr),32);
        tracep->fullIData(oldp+31,(vlTOPp->top__DOT__cpu__DOT__next_pc),32);
        tracep->fullBit(oldp+32,(vlTOPp->top__DOT__cpu__DOT__irq_delay));
        tracep->fullBit(oldp+33,(vlTOPp->top__DOT__cpu__DOT__irq_active));
        tracep->fullIData(oldp+34,(vlTOPp->top__DOT__cpu__DOT__irq_mask),32);
        tracep->fullIData(oldp+35,(vlTOPp->top__DOT__cpu__DOT__irq_pending),32);
        tracep->fullIData(oldp+36,(vlTOPp->top__DOT__cpu__DOT__timer),32);
        tracep->fullIData(oldp+37,(vlTOPp->top__DOT__cpu__DOT__cpuregs[0]),32);
        tracep->fullIData(oldp+38,(vlTOPp->top__DOT__cpu__DOT__cpuregs[1]),32);
        tracep->fullIData(oldp+39,(vlTOPp->top__DOT__cpu__DOT__cpuregs[2]),32);
        tracep->fullIData(oldp+40,(vlTOPp->top__DOT__cpu__DOT__cpuregs[3]),32);
        tracep->fullIData(oldp+41,(vlTOPp->top__DOT__cpu__DOT__cpuregs[4]),32);
        tracep->fullIData(oldp+42,(vlTOPp->top__DOT__cpu__DOT__cpuregs[5]),32);
        tracep->fullIData(oldp+43,(vlTOPp->top__DOT__cpu__DOT__cpuregs[6]),32);
        tracep->fullIData(oldp+44,(vlTOPp->top__DOT__cpu__DOT__cpuregs[7]),32);
        tracep->fullIData(oldp+45,(vlTOPp->top__DOT__cpu__DOT__cpuregs[8]),32);
        tracep->fullIData(oldp+46,(vlTOPp->top__DOT__cpu__DOT__cpuregs[9]),32);
        tracep->fullIData(oldp+47,(vlTOPp->top__DOT__cpu__DOT__cpuregs[10]),32);
        tracep->fullIData(oldp+48,(vlTOPp->top__DOT__cpu__DOT__cpuregs[11]),32);
        tracep->fullIData(oldp+49,(vlTOPp->top__DOT__cpu__DOT__cpuregs[12]),32);
        tracep->fullIData(oldp+50,(vlTOPp->top__DOT__cpu__DOT__cpuregs[13]),32);
        tracep->fullIData(oldp+51,(vlTOPp->top__DOT__cpu__DOT__cpuregs[14]),32);
        tracep->fullIData(oldp+52,(vlTOPp->top__DOT__cpu__DOT__cpuregs[15]),32);
        tracep->fullIData(oldp+53,(vlTOPp->top__DOT__cpu__DOT__cpuregs[16]),32);
        tracep->fullIData(oldp+54,(vlTOPp->top__DOT__cpu__DOT__cpuregs[17]),32);
        tracep->fullIData(oldp+55,(vlTOPp->top__DOT__cpu__DOT__cpuregs[18]),32);
        tracep->fullIData(oldp+56,(vlTOPp->top__DOT__cpu__DOT__cpuregs[19]),32);
        tracep->fullIData(oldp+57,(vlTOPp->top__DOT__cpu__DOT__cpuregs[20]),32);
        tracep->fullIData(oldp+58,(vlTOPp->top__DOT__cpu__DOT__cpuregs[21]),32);
        tracep->fullIData(oldp+59,(vlTOPp->top__DOT__cpu__DOT__cpuregs[22]),32);
        tracep->fullIData(oldp+60,(vlTOPp->top__DOT__cpu__DOT__cpuregs[23]),32);
        tracep->fullIData(oldp+61,(vlTOPp->top__DOT__cpu__DOT__cpuregs[24]),32);
        tracep->fullIData(oldp+62,(vlTOPp->top__DOT__cpu__DOT__cpuregs[25]),32);
        tracep->fullIData(oldp+63,(vlTOPp->top__DOT__cpu__DOT__cpuregs[26]),32);
        tracep->fullIData(oldp+64,(vlTOPp->top__DOT__cpu__DOT__cpuregs[27]),32);
        tracep->fullIData(oldp+65,(vlTOPp->top__DOT__cpu__DOT__cpuregs[28]),32);
        tracep->fullIData(oldp+66,(vlTOPp->top__DOT__cpu__DOT__cpuregs[29]),32);
        tracep->fullIData(oldp+67,(vlTOPp->top__DOT__cpu__DOT__cpuregs[30]),32);
        tracep->fullIData(oldp+68,(vlTOPp->top__DOT__cpu__DOT__cpuregs[31]),32);
        tracep->fullBit(oldp+69,(vlTOPp->top__DOT__cpu__DOT__pcpi_mul_wr));
        tracep->fullIData(oldp+70,(vlTOPp->top__DOT__cpu__DOT__pcpi_mul_rd),32);
        tracep->fullBit(oldp+71,(vlTOPp->top__DOT__cpu__DOT__pcpi_mul_wait));
        tracep->fullBit(oldp+72,(vlTOPp->top__DOT__cpu__DOT__pcpi_mul_ready));
        tracep->fullBit(oldp+73,(vlTOPp->top__DOT__cpu__DOT__pcpi_div_wr));
        tracep->fullIData(oldp+74,(vlTOPp->top__DOT__cpu__DOT__pcpi_div_rd),32);
        tracep->fullBit(oldp+75,(vlTOPp->top__DOT__cpu__DOT__pcpi_div_wait));
        tracep->fullBit(oldp+76,(vlTOPp->top__DOT__cpu__DOT__pcpi_div_ready));
        tracep->fullBit(oldp+77,(vlTOPp->top__DOT__cpu__DOT__pcpi_int_wr));
        tracep->fullIData(oldp+78,(vlTOPp->top__DOT__cpu__DOT__pcpi_int_rd),32);
        tracep->fullBit(oldp+79,(((IData)(vlTOPp->top__DOT__cpu__DOT__pcpi_mul_wait) 
                                  | (IData)(vlTOPp->top__DOT__cpu__DOT__pcpi_div_wait))));
        tracep->fullBit(oldp+80,(vlTOPp->top__DOT__cpu__DOT__pcpi_int_ready));
        tracep->fullCData(oldp+81,(vlTOPp->top__DOT__cpu__DOT__mem_state),2);
        tracep->fullCData(oldp+82,(vlTOPp->top__DOT__cpu__DOT__mem_wordsize),2);
        tracep->fullIData(oldp+83,(vlTOPp->top__DOT__cpu__DOT__mem_rdata_word),32);
        tracep->fullIData(oldp+84,(vlTOPp->top__DOT__cpu__DOT__mem_rdata_q),32);
        tracep->fullBit(oldp+85,(vlTOPp->top__DOT__cpu__DOT__mem_do_prefetch));
        tracep->fullBit(oldp+86,(vlTOPp->top__DOT__cpu__DOT__mem_do_rinst));
        tracep->fullBit(oldp+87,(vlTOPp->top__DOT__cpu__DOT__mem_do_rdata));
        tracep->fullBit(oldp+88,(vlTOPp->top__DOT__cpu__DOT__mem_do_wdata));
        ...
        tracep->fullBit(oldp+270,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_div));
        tracep->fullBit(oldp+271,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_divu));
        tracep->fullBit(oldp+272,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_rem));
        tracep->fullBit(oldp+273,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_remu));
        tracep->fullBit(oldp+274,(((IData)(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_div) 
                                   | ((IData)(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_divu) 
                                      | ((IData)(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_rem) 
                                         | (IData)(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_remu))))));
        tracep->fullBit(oldp+275,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__pcpi_wait_q));
        tracep->fullBit(oldp+276,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__start));
        tracep->fullIData(oldp+277,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__dividend),32);
        tracep->fullQData(oldp+278,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__divisor),63);
        tracep->fullIData(oldp+280,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__quotient),32);
        tracep->fullIData(oldp+281,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__quotient_msk),32);
        tracep->fullBit(oldp+282,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__running));
        tracep->fullBit(oldp+283,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__outsign));
        tracep->fullBit(oldp+284,(vlTOPp->top__DOT__my_accel__DOT__pcpi_wr));
        tracep->fullBit(oldp+285,((0xbU == (0x7fU & vlTOPp->top__DOT__pcpi_insn))));
        tracep->fullCData(oldp+286,(vlTOPp->top__DOT__my_accel__DOT__a_raw[0]),4);
        tracep->fullCData(oldp+287,(vlTOPp->top__DOT__my_accel__DOT__a_raw[1]),4);
        tracep->fullCData(oldp+288,(vlTOPp->top__DOT__my_accel__DOT__a_raw[2]),4);
        tracep->fullCData(oldp+289,(vlTOPp->top__DOT__my_accel__DOT__a_raw[3]),4);
        tracep->fullCData(oldp+290,(vlTOPp->top__DOT__my_accel__DOT__a_raw[4]),4);
        tracep->fullCData(oldp+291,(vlTOPp->top__DOT__my_accel__DOT__a_raw[5]),4);
        tracep->fullCData(oldp+292,(vlTOPp->top__DOT__my_accel__DOT__a_raw[6]),4);
        tracep->fullCData(oldp+293,(vlTOPp->top__DOT__my_accel__DOT__a_raw[7]),4);
        tracep->fullCData(oldp+294,(vlTOPp->top__DOT__my_accel__DOT__b_raw[0]),4);
        tracep->fullCData(oldp+295,(vlTOPp->top__DOT__my_accel__DOT__b_raw[1]),4);
        tracep->fullCData(oldp+296,(vlTOPp->top__DOT__my_accel__DOT__b_raw[2]),4);
        tracep->fullCData(oldp+297,(vlTOPp->top__DOT__my_accel__DOT__b_raw[3]),4);
        tracep->fullCData(oldp+298,(vlTOPp->top__DOT__my_accel__DOT__b_raw[4]),4);
        tracep->fullCData(oldp+299,(vlTOPp->top__DOT__my_accel__DOT__b_raw[5]),4);
        tracep->fullCData(oldp+300,(vlTOPp->top__DOT__my_accel__DOT__b_raw[6]),4);
        tracep->fullCData(oldp+301,(vlTOPp->top__DOT__my_accel__DOT__b_raw[7]),4);
        tracep->fullSData(oldp+302,(vlTOPp->top__DOT__my_accel__DOT__a_val[0]),12);
        tracep->fullSData(oldp+303,(vlTOPp->top__DOT__my_accel__DOT__a_val[1]),12);
        tracep->fullSData(oldp+304,(vlTOPp->top__DOT__my_accel__DOT__a_val[2]),12);
        tracep->fullSData(oldp+305,(vlTOPp->top__DOT__my_accel__DOT__a_val[3]),12);
        tracep->fullSData(oldp+306,(vlTOPp->top__DOT__my_accel__DOT__a_val[4]),12);
        tracep->fullSData(oldp+307,(vlTOPp->top__DOT__my_accel__DOT__a_val[5]),12);
        tracep->fullSData(oldp+308,(vlTOPp->top__DOT__my_accel__DOT__a_val[6]),12);
        tracep->fullSData(oldp+309,(vlTOPp->top__DOT__my_accel__DOT__a_val[7]),12);
        tracep->fullSData(oldp+310,(vlTOPp->top__DOT__my_accel__DOT__b_val[0]),12);
        tracep->fullSData(oldp+311,(vlTOPp->top__DOT__my_accel__DOT__b_val[1]),12);
        tracep->fullSData(oldp+312,(vlTOPp->top__DOT__my_accel__DOT__b_val[2]),12);
        tracep->fullSData(oldp+313,(vlTOPp->top__DOT__my_accel__DOT__b_val[3]),12);
        tracep->fullSData(oldp+314,(vlTOPp->top__DOT__my_accel__DOT__b_val[4]),12);
        tracep->fullSData(oldp+315,(vlTOPp->top__DOT__my_accel__DOT__b_val[5]),12);
        tracep->fullSData(oldp+316,(vlTOPp->top__DOT__my_accel__DOT__b_val[6]),12);
        tracep->fullSData(oldp+317,(vlTOPp->top__DOT__my_accel__DOT__b_val[7]),12);
        tracep->fullIData(oldp+318,(vlTOPp->top__DOT__my_accel__DOT__prod[0]),24);
        tracep->fullIData(oldp+319,(vlTOPp->top__DOT__my_accel__DOT__prod[1]),24);
        tracep->fullIData(oldp+320,(vlTOPp->top__DOT__my_accel__DOT__prod[2]),24);
        tracep->fullIData(oldp+321,(vlTOPp->top__DOT__my_accel__DOT__prod[3]),24);
        tracep->fullIData(oldp+322,(vlTOPp->top__DOT__my_accel__DOT__prod[4]),24);
        tracep->fullIData(oldp+323,(vlTOPp->top__DOT__my_accel__DOT__prod[5]),24);
        tracep->fullIData(oldp+324,(vlTOPp->top__DOT__my_accel__DOT__prod[6]),24);
        tracep->fullIData(oldp+325,(vlTOPp->top__DOT__my_accel__DOT__prod[7]),24);
        tracep->fullIData(oldp+326,((((((((VL_EXTENDS_II(32,24, 
                                     ...
                                     + VL_EXTENDS_II(32,24, 
                                                     vlTOPp->top__DOT__my_accel__DOT__prod
                                                     [7U]))),32);
        tracep->fullBit(oldp+327,(vlTOPp->top__DOT__cpu__DOT__mem_la_read));
        tracep->fullBit(oldp+328,(vlTOPp->top__DOT__cpu__DOT__mem_la_write));
        tracep->fullBit(oldp+329,(vlTOPp->top__DOT__cpu__DOT__clear_prefetched_high_word));
        tracep->fullBit(oldp+330,(vlTOPp->top__DOT__cpu__DOT__mem_done));
        tracep->fullBit(oldp+331,(vlTOPp->clk));
        tracep->fullBit(oldp+332,(vlTOPp->resetn));
        tracep->fullBit(oldp+333,(vlTOPp->trap));
        tracep->fullIData(oldp+334,(vlTOPp->out_data),32);
        tracep->fullBit(oldp+335,(vlTOPp->out_valid));
        tracep->fullIData(oldp+336,(0x10000U),32);
        ...
        tracep->fullIData(oldp+344,(0x10000U),32);
        tracep->fullIData(oldp+345,(vlTOPp->top__DOT__cpu__DOT__irq),32);
        tracep->fullIData(oldp+346,(0U),32);
        tracep->fullIData(oldp+347,(1U),32);
        tracep->fullIData(oldp+348,(2U),32);
        tracep->fullIData(oldp+349,(0x20U),32);
        tracep->fullIData(oldp+350,(5U),32);
        tracep->fullQData(oldp+351,(0x100000000ULL),36);
        tracep->fullQData(oldp+353,(0x200000000ULL),36);
        tracep->fullQData(oldp+355,(0x800000000ULL),36);
        tracep->fullIData(oldp+357,(vlTOPp->top__DOT__cpu__DOT__i),32);
        tracep->fullSData(oldp+358,(vlTOPp->top__DOT__cpu__DOT__mem_16bit_buffer),16);
        tracep->fullCData(oldp+359,(0x80U),8);
        tracep->fullCData(oldp+360,(0x40U),8);
        tracep->fullCData(oldp+361,(0x20U),8);
        tracep->fullCData(oldp+362,(0x10U),8);
        tracep->fullCData(oldp+363,(8U),8);
        tracep->fullCData(oldp+364,(4U),8);
        tracep->fullCData(oldp+365,(2U),8);
        tracep->fullCData(oldp+366,(1U),8);
