...
void Vtop::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgIData(oldp+2,(vlTOPp->top__DOT__mem_addr),32);
            tracep->chgIData(oldp+3,(vlTOPp->top__DOT__mem_wdata),32);
            tracep->chgCData(oldp+4,(vlTOPp->top__DOT__mem_wstrb),4);
            tracep->chgIData(oldp+5,(vlTOPp->top__DOT__mem_rdata),32);
            tracep->chgBit(oldp+6,(vlTOPp->top__DOT__pcpi_valid));
            tracep->chgIData(oldp+7,(vlTOPp->top__DOT__pcpi_insn),32);
            tracep->chgIData(oldp+8,(vlTOPp->top__DOT__cpu__DOT__reg_op1),32);
            tracep->chgIData(oldp+9,(vlTOPp->top__DOT__cpu__DOT__reg_op2),32);
            tracep->chgIData(oldp+10,(vlTOPp->top__DOT__pcpi_rd),32);
            tracep->chgBit(oldp+11,(vlTOPp->top__DOT__pcpi_ready));
            tracep->chgIData(oldp+12,((((IData)(vlTOPp->top__DOT__cpu__DOT__mem_do_prefetch) 
                                        | (IData)(vlTOPp->top__DOT__cpu__DOT__mem_do_rinst))
                                        ? (0xfffffffcU 
                                           & vlTOPp->top__DOT__cpu__DOT__next_pc)
                                        : (0xfffffffcU 
                                           & vlTOPp->top__DOT__cpu__DOT__reg_op1))),32);
            tracep->chgIData(oldp+13,(vlTOPp->top__DOT__cpu__DOT__mem_la_wdata),32);
            tracep->chgCData(oldp+14,(vlTOPp->top__DOT__cpu__DOT__mem_la_wstrb),4);
            tracep->chgIData(oldp+15,(vlTOPp->top__DOT__cpu__DOT__eoi),32);
            tracep->chgBit(oldp+16,(vlTOPp->top__DOT__cpu__DOT__trace_valid));
            tracep->chgQData(oldp+17,(vlTOPp->top__DOT__cpu__DOT__trace_data),36);
            tracep->chgQData(oldp+19,(vlTOPp->top__DOT__cpu__DOT__count_cycle),64);
            tracep->chgQData(oldp+21,(vlTOPp->top__DOT__cpu__DOT__count_instr),64);
            tracep->chgIData(oldp+23,(vlTOPp->top__DOT__cpu__DOT__reg_pc),32);
            tracep->chgIData(oldp+24,(vlTOPp->top__DOT__cpu__DOT__reg_next_pc),32);
            tracep->chgIData(oldp+25,(vlTOPp->top__DOT__cpu__DOT__reg_out),32);
            tracep->chgCData(oldp+26,(vlTOPp->top__DOT__cpu__DOT__reg_sh),5);
            tracep->chgIData(oldp+27,(vlTOPp->top__DOT__cpu__DOT__next_insn_opcode),32);
            tracep->chgIData(oldp+28,(vlTOPp->top__DOT__cpu__DOT__dbg_insn_opcode),32);
            tracep->chgIData(oldp+29,(vlTOPp->top__DOT__cpu__DOT__dbg_insn_addr),32);
            tracep->chgIData(oldp+30,(vlTOPp->top__DOT__cpu__DOT__next_pc),32);
            tracep->chgBit(oldp+31,(vlTOPp->top__DOT__cpu__DOT__irq_delay));
            tracep->chgBit(oldp+32,(vlTOPp->top__DOT__cpu__DOT__irq_active));
            tracep->chgIData(oldp+33,(vlTOPp->top__DOT__cpu__DOT__irq_mask),32);
            tracep->chgIData(oldp+34,(vlTOPp->top__DOT__cpu__DOT__irq_pending),32);
            tracep->chgIData(oldp+35,(vlTOPp->top__DOT__cpu__DOT__timer),32);
            tracep->chgIData(oldp+36,(vlTOPp->top__DOT__cpu__DOT__cpuregs[0]),32);
            tracep->chgIData(oldp+37,(vlTOPp->top__DOT__cpu__DOT__cpuregs[1]),32);
            tracep->chgIData(oldp+38,(vlTOPp->top__DOT__cpu__DOT__cpuregs[2]),32);
            tracep->chgIData(oldp+39,(vlTOPp->top__DOT__cpu__DOT__cpuregs[3]),32);
            tracep->chgIData(oldp+40,(vlTOPp->top__DOT__cpu__DOT__cpuregs[4]),32);
            tracep->chgIData(oldp+41,(vlTOPp->top__DOT__cpu__DOT__cpuregs[5]),32);
            tracep->chgIData(oldp+42,(vlTOPp->top__DOT__cpu__DOT__cpuregs[6]),32);
            tracep->chgIData(oldp+43,(vlTOPp->top__DOT__cpu__DOT__cpuregs[7]),32);
            tracep->chgIData(oldp+44,(vlTOPp->top__DOT__cpu__DOT__cpuregs[8]),32);
            tracep->chgIData(oldp+45,(vlTOPp->top__DOT__cpu__DOT__cpuregs[9]),32);
            tracep->chgIData(oldp+46,(vlTOPp->top__DOT__cpu__DOT__cpuregs[10]),32);
            tracep->chgIData(oldp+47,(vlTOPp->top__DOT__cpu__DOT__cpuregs[11]),32);
            tracep->chgIData(oldp+48,(vlTOPp->top__DOT__cpu__DOT__cpuregs[12]),32);
            tracep->chgIData(oldp+49,(vlTOPp->top__DOT__cpu__DOT__cpuregs[13]),32);
            tracep->chgIData(oldp+50,(vlTOPp->top__DOT__cpu__DOT__cpuregs[14]),32);
            tracep->chgIData(oldp+51,(vlTOPp->top__DOT__cpu__DOT__cpuregs[15]),32);
            tracep->chgIData(oldp+52,(vlTOPp->top__DOT__cpu__DOT__cpuregs[16]),32);
            tracep->chgIData(oldp+53,(vlTOPp->top__DOT__cpu__DOT__cpuregs[17]),32);
            tracep->chgIData(oldp+54,(vlTOPp->top__DOT__cpu__DOT__cpuregs[18]),32);
            tracep->chgIData(oldp+55,(vlTOPp->top__DOT__cpu__DOT__cpuregs[19]),32);
            tracep->chgIData(oldp+56,(vlTOPp->top__DOT__cpu__DOT__cpuregs[20]),32);
            tracep->chgIData(oldp+57,(vlTOPp->top__DOT__cpu__DOT__cpuregs[21]),32);
            tracep->chgIData(oldp+58,(vlTOPp->top__DOT__cpu__DOT__cpuregs[22]),32);
            tracep->chgIData(oldp+59,(vlTOPp->top__DOT__cpu__DOT__cpuregs[23]),32);
            tracep->chgIData(oldp+60,(vlTOPp->top__DOT__cpu__DOT__cpuregs[24]),32);
            tracep->chgIData(oldp+61,(vlTOPp->top__DOT__cpu__DOT__cpuregs[25]),32);
            tracep->chgIData(oldp+62,(vlTOPp->top__DOT__cpu__DOT__cpuregs[26]),32);
            tracep->chgIData(oldp+63,(vlTOPp->top__DOT__cpu__DOT__cpuregs[27]),32);
            tracep->chgIData(oldp+64,(vlTOPp->top__DOT__cpu__DOT__cpuregs[28]),32);
            tracep->chgIData(oldp+65,(vlTOPp->top__DOT__cpu__DOT__cpuregs[29]),32);
            tracep->chgIData(oldp+66,(vlTOPp->top__DOT__cpu__DOT__cpuregs[30]),32);
            tracep->chgIData(oldp+67,(vlTOPp->top__DOT__cpu__DOT__cpuregs[31]),32);
            tracep->chgBit(oldp+68,(vlTOPp->top__DOT__cpu__DOT__pcpi_mul_wr));
            tracep->chgIData(oldp+69,(vlTOPp->top__DOT__cpu__DOT__pcpi_mul_rd),32);
            tracep->chgBit(oldp+70,(vlTOPp->top__DOT__cpu__DOT__pcpi_mul_wait));
            tracep->chgBit(oldp+71,(vlTOPp->top__DOT__cpu__DOT__pcpi_mul_ready));
            tracep->chgBit(oldp+72,(vlTOPp->top__DOT__cpu__DOT__pcpi_div_wr));
            tracep->chgIData(oldp+73,(vlTOPp->top__DOT__cpu__DOT__pcpi_div_rd),32);
            tracep->chgBit(oldp+74,(vlTOPp->top__DOT__cpu__DOT__pcpi_div_wait));
            tracep->chgBit(oldp+75,(vlTOPp->top__DOT__cpu__DOT__pcpi_div_ready));
            tracep->chgBit(oldp+76,(vlTOPp->top__DOT__cpu__DOT__pcpi_int_wr));
            tracep->chgIData(oldp+77,(vlTOPp->top__DOT__cpu__DOT__pcpi_int_rd),32);
            tracep->chgBit(oldp+78,(((IData)(vlTOPp->top__DOT__cpu__DOT__pcpi_mul_wait) 
                                     | (IData)(vlTOPp->top__DOT__cpu__DOT__pcpi_div_wait))));
            tracep->chgBit(oldp+79,(vlTOPp->top__DOT__cpu__DOT__pcpi_int_ready));
            tracep->chgCData(oldp+80,(vlTOPp->top__DOT__cpu__DOT__mem_state),2);
            tracep->chgCData(oldp+81,(vlTOPp->top__DOT__cpu__DOT__mem_wordsize),2);
            tracep->chgIData(oldp+82,(vlTOPp->top__DOT__cpu__DOT__mem_rdata_word),32);
            tracep->chgIData(oldp+83,(vlTOPp->top__DOT__cpu__DOT__mem_rdata_q),32);
            tracep->chgBit(oldp+84,(vlTOPp->top__DOT__cpu__DOT__mem_do_prefetch));
            tracep->chgBit(oldp+85,(vlTOPp->top__DOT__cpu__DOT__mem_do_rinst));
            tracep->chgBit(oldp+86,(vlTOPp->top__DOT__cpu__DOT__mem_do_rdata));
            tracep->chgBit(oldp+87,(vlTOPp->top__DOT__cpu__DOT__mem_do_wdata));
            ...
            tracep->chgBit(oldp+269,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_div));
            tracep->chgBit(oldp+270,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_divu));
            tracep->chgBit(oldp+271,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_rem));
            tracep->chgBit(oldp+272,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_remu));
            tracep->chgBit(oldp+273,(((IData)(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__instr_div) 
            ...
            tracep->chgBit(oldp+274,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__pcpi_wait_q));
            tracep->chgBit(oldp+275,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__start));
            tracep->chgIData(oldp+276,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__dividend),32);
            tracep->chgQData(oldp+277,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__divisor),63);
            tracep->chgIData(oldp+279,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__quotient),32);
            tracep->chgIData(oldp+280,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__quotient_msk),32);
            tracep->chgBit(oldp+281,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__running));
            tracep->chgBit(oldp+282,(vlTOPp->top__DOT__cpu__DOT__genblk4__DOT__pcpi_div__DOT__outsign));
            tracep->chgBit(oldp+283,(vlTOPp->top__DOT__my_accel__DOT__pcpi_wr));
            tracep->chgBit(oldp+284,((0xbU == (0x7fU 
                                               & vlTOPp->top__DOT__pcpi_insn))));
            tracep->chgCData(oldp+285,(vlTOPp->top__DOT__my_accel__DOT__a_raw[0]),4);
            tracep->chgCData(oldp+286,(vlTOPp->top__DOT__my_accel__DOT__a_raw[1]),4);
            tracep->chgCData(oldp+287,(vlTOPp->top__DOT__my_accel__DOT__a_raw[2]),4);
            tracep->chgCData(oldp+288,(vlTOPp->top__DOT__my_accel__DOT__a_raw[3]),4);
            tracep->chgCData(oldp+289,(vlTOPp->top__DOT__my_accel__DOT__a_raw[4]),4);
            tracep->chgCData(oldp+290,(vlTOPp->top__DOT__my_accel__DOT__a_raw[5]),4);
            tracep->chgCData(oldp+291,(vlTOPp->top__DOT__my_accel__DOT__a_raw[6]),4);
            tracep->chgCData(oldp+292,(vlTOPp->top__DOT__my_accel__DOT__a_raw[7]),4);
            tracep->chgCData(oldp+293,(vlTOPp->top__DOT__my_accel__DOT__b_raw[0]),4);
            tracep->chgCData(oldp+294,(vlTOPp->top__DOT__my_accel__DOT__b_raw[1]),4);
            tracep->chgCData(oldp+295,(vlTOPp->top__DOT__my_accel__DOT__b_raw[2]),4);
            tracep->chgCData(oldp+296,(vlTOPp->top__DOT__my_accel__DOT__b_raw[3]),4);
            tracep->chgCData(oldp+297,(vlTOPp->top__DOT__my_accel__DOT__b_raw[4]),4);
            tracep->chgCData(oldp+298,(vlTOPp->top__DOT__my_accel__DOT__b_raw[5]),4);
            tracep->chgCData(oldp+299,(vlTOPp->top__DOT__my_accel__DOT__b_raw[6]),4);
            tracep->chgCData(oldp+300,(vlTOPp->top__DOT__my_accel__DOT__b_raw[7]),4);
            tracep->chgSData(oldp+301,(vlTOPp->top__DOT__my_accel__DOT__a_val[0]),12);
            tracep->chgSData(oldp+302,(vlTOPp->top__DOT__my_accel__DOT__a_val[1]),12);
            tracep->chgSData(oldp+303,(vlTOPp->top__DOT__my_accel__DOT__a_val[2]),12);
            tracep->chgSData(oldp+304,(vlTOPp->top__DOT__my_accel__DOT__a_val[3]),12);
            tracep->chgSData(oldp+305,(vlTOPp->top__DOT__my_accel__DOT__a_val[4]),12);
            tracep->chgSData(oldp+306,(vlTOPp->top__DOT__my_accel__DOT__a_val[5]),12);
            tracep->chgSData(oldp+307,(vlTOPp->top__DOT__my_accel__DOT__a_val[6]),12);
            tracep->chgSData(oldp+308,(vlTOPp->top__DOT__my_accel__DOT__a_val[7]),12);
            tracep->chgSData(oldp+309,(vlTOPp->top__DOT__my_accel__DOT__b_val[0]),12);
            tracep->chgSData(oldp+310,(vlTOPp->top__DOT__my_accel__DOT__b_val[1]),12);
            tracep->chgSData(oldp+311,(vlTOPp->top__DOT__my_accel__DOT__b_val[2]),12);
            tracep->chgSData(oldp+312,(vlTOPp->top__DOT__my_accel__DOT__b_val[3]),12);
            tracep->chgSData(oldp+313,(vlTOPp->top__DOT__my_accel__DOT__b_val[4]),12);
            tracep->chgSData(oldp+314,(vlTOPp->top__DOT__my_accel__DOT__b_val[5]),12);
            tracep->chgSData(oldp+315,(vlTOPp->top__DOT__my_accel__DOT__b_val[6]),12);
            tracep->chgSData(oldp+316,(vlTOPp->top__DOT__my_accel__DOT__b_val[7]),12);
            tracep->chgIData(oldp+317,(vlTOPp->top__DOT__my_accel__DOT__prod[0]),24);
            tracep->chgIData(oldp+318,(vlTOPp->top__DOT__my_accel__DOT__prod[1]),24);
            tracep->chgIData(oldp+319,(vlTOPp->top__DOT__my_accel__DOT__prod[2]),24);
            tracep->chgIData(oldp+320,(vlTOPp->top__DOT__my_accel__DOT__prod[3]),24);
            tracep->chgIData(oldp+321,(vlTOPp->top__DOT__my_accel__DOT__prod[4]),24);
            tracep->chgIData(oldp+322,(vlTOPp->top__DOT__my_accel__DOT__prod[5]),24);
            tracep->chgIData(oldp+323,(vlTOPp->top__DOT__my_accel__DOT__prod[6]),24);
            tracep->chgIData(oldp+324,(vlTOPp->top__DOT__my_accel__DOT__prod[7]),24);
            tracep->chgIData(oldp+325,((((((((VL_EXTENDS_II(32,24, 
        ...
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[2U])) {
            tracep->chgBit(oldp+326,(vlTOPp->top__DOT__cpu__DOT__mem_la_read));
            tracep->chgBit(oldp+327,(vlTOPp->top__DOT__cpu__DOT__mem_la_write));
            tracep->chgBit(oldp+328,(vlTOPp->top__DOT__cpu__DOT__clear_prefetched_high_word));
            tracep->chgBit(oldp+329,(vlTOPp->top__DOT__cpu__DOT__mem_done));
        }
        tracep->chgBit(oldp+330,(vlTOPp->clk));
        tracep->chgBit(oldp+331,(vlTOPp->resetn));
        tracep->chgBit(oldp+332,(vlTOPp->trap));
        tracep->chgIData(oldp+333,(vlTOPp->out_data),32);
        tracep->chgBit(oldp+334,(vlTOPp->out_valid));
    }
}
